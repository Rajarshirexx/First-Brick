            ...
            <div className="container px-6 flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
                ...
                <div className="flex-1 text-center lg:text-left animate-fadeIn">
                    ...
                    <div className="flex flex-col sm:flex-row gap-5 justify-center lg:justify-start animate-fadeIn delay-500">
                        <Link to="/projects" className="btn-accent px-10 py-3.5 text-sm font-bold uppercase tracking-widest hover:-translate-y-1 transition-transform text-center">
                            Explore Projects
                        </Link>
                        <Link to="/about" className="px-10 py-3.5 border border-white/20 text-white text-sm font-bold uppercase tracking-widest rounded-lg hover:bg-white hover:text-primary transition-all duration-300 hover:-translate-y-1 text-center">
                            Our Vision
                        </Link>
                    </div>
