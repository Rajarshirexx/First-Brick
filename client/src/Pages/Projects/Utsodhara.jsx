                        ...
                        <div className="relative group overflow-hidden rounded-[2.5rem] shadow-2xl animate-fadeIn">
                            ...
                            <div className="relative p-10 text-white flex flex-col items-center text-center">
                                ...
                                <a 
                                    ...
                                    className="bg-white text-secondary px-8 py-3 rounded-full font-bold text-xs uppercase tracking-[0.2em] shadow-lg hover:translate-y-[-2px] hover:shadow-2xl transition-all"
                                >
                                    Download Brochure
                                </a>
                            </div>
