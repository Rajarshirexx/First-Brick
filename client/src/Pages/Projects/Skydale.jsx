                    ...
                    <div className="lg:col-span-5 space-y-10 animate-fadeIn delay-300">
                        ...
                        <div className="bg-[#083333] p-10 rounded-2xl text-white shadow-2xl relative overflow-hidden group">
                            ...
                            <a 
                                ...
                                className="inline-flex items-center justify-center bg-secondary w-full py-4 rounded-xl font-bold uppercase tracking-[0.2em] text-xs hover:bg-white hover:text-[#083333] transition-all duration-300 shadow-lg mb-8"
                            >
                                Download E-Brochure
                            </a>
                            
                            {/* Standardized Enquiry Section */}
                            <ProjectEnquiry projectName="Skydale" isDark={true} accentColor="#f7941d" />
                        </div>
                    </div>
                </div>
