...
export default function Senses() {
    ...
    const projectEssentials = [
        { label: "Starting Price", value: "₹31.88 Lacs*", icon: <FiTag /> },
        { label: "Location", value: "Siliguri, India", icon: <FiMapPin /> },
        { label: "Project Area", value: "1200 - 1800 sqft", icon: <FiMaximize /> },
        { label: "Configuration", value: "1, 2, 3 BHK", icon: <FiGrid /> }
    ];
